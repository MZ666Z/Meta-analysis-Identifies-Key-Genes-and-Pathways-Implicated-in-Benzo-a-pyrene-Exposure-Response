...
library(readxl)
GSE37326 <- read_excel("C:\\Users\\zhu66\\OneDrive - University of Oklahoma\\Desktop\\GEO\\meta-analysis\\sensitivity analysis-log2\\metavolcano\\GSE37326-7.17.2022.xlsx",sheet = "Sheet1")
GSE117527 <- read_excel("C:\\Users\\zhu66\\OneDrive - University of Oklahoma\\Desktop\\GEO\\meta-analysis\\sensitivity analysis-log2\\metavolcano\\GSE117527-7.17.2022.xlsx",sheet = "Sheet1")
GSE36244 <- read_excel("C:\\Users\\zhu66\\OneDrive - University of Oklahoma\\Desktop\\GEO\\meta-analysis\\sensitivity analysis-log2\\metavolcano\\GSE36244-7.17.2022.xlsx",sheet = "Sheet1")
GSE75783 <- read_excel("C:\\Users\\zhu66\\OneDrive - University of Oklahoma\\Desktop\\GEO\\meta-analysis\\sensitivity analysis-log2\\metavolcano\\GSE75783-7.17.2022.xlsx",sheet = "Sheet1")
...
library(xlsx)
write.xlsx(p_value,file = 'p_metavolcano-sensitivity-7.17.2022.xlsx',sheetName = "Sheet1", append = F)
...
# sig_p2 <- subset(p1,adjusted.P<0.05)


library(xlsx)
write.xlsx(p1,file = 'adjustedp_metavolcano-sensitivity-7.17.2022.xlsx',sheetName = "Sheet1", append = F)
